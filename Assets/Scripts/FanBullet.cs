...
using UnityEngine;
    ...
    [Range(0, 2.5f)] public float BulletSpread = 1;
    [HideInInspector] public List<Vector3> Targets,OGTargets;
           ...
           for (int j = 0; j < BulletsPerVolley; j++)
            {
                ...
                Bullet.GetComponent<Rigidbody2D>().velocity= (( Targets[j]- transform.position ).normalized*5);
            }
